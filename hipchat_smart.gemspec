Gem::Specification.new do |s|
  ...
  s.version     = '1.0.0'
  s.date        = '2018-03-14'
  s.summary     = "Create a hipchat bot that is really smart and so easy to expand, create new bots on demand, run ruby code on chat, create shortcuts..."
  s.description = "The main scope of this gem is to be used internally in your company so teams can create team rooms with their own bot to help them on their daily work, almost everything is suitable to be automated!! hipchat_smart can create bots on demand, create shortcuts, run ruby code... just on a chat room, you can access it just from your mobile phone if you want and run those tests you forgot to run, get the results, restart a server... no limits."
